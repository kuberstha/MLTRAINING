...
<body>
    ...
    <div class="col-md-12">
		...
		<div class="col-sm-10">
		   <input class="form-check-input" type="radio" name="Domain" id="Domain" value= "SAP" <?php echo $userData['Domain']=='SAP'? 'checked' : '' ?>>  SAP &nbsp; &nbsp;
		  <input class="form-check-input" type="radio" name="Domain" id="Domain" value= "NON SAP" <?php echo $userData['Domain']=='NON SAP'? 'checked' : '' ?>>    NON SAP  &nbsp; &nbsp;
		  <input class="form-check-input" type="radio" name="Domain" id="Domain" value= "INFRA" <?php echo $userData['Domain']=='INFRA'? 'checked' : '' ?>>    INFRA  &nbsp; &nbsp;
		  <input class="form-check-input" type="radio" name="Domain" id="Domain" value= "SECURITY" <?php echo $userData['Domain']=='SECURITY'? 'checked' : '' ?>>    SECURITY  &nbsp; &nbsp;
		   ...
		   <div class="form-group row">
			...
			<input class="form-check-input" type="radio" name="Type" id="Type" value= "E" <?php echo $userData['Type']=='E'? 'checked' : '' ?>>    ESCALATION  &nbsp; &nbsp;
		    <input class="form-check-input" type="radio" name="Type" id="Type" value= "F" <?php echo $userData['Type']=='F'? 'checked' : '' ?>>    FOLLOWUP  &nbsp; &nbsp;
			<input class="form-check-input" type="radio" name="Type" id="Type" value= "R" <?php echo $userData['Type']=='R'? 'checked' : '' ?>>  REMINDER &nbsp; &nbsp;
		  </div>
		  </div>  
		  <div class="form-group row">
			<label for="inputPassword3" class="col-sm-2 col-form-label">Enable Notification :</label>
			<div class="col-sm-10">
		   <!-- <input type="text" class="form-control" name="Enabled" placeholder="YES | NO" value="<?php echo !empty($userData['Enabled'])?$userData['Enabled']:''; ?>" required=""> -->
			<input class="form-check-input" type="radio" name="Enabled" id="Enabled" value= "Yes" <?php echo $userData['Enabled']=='Yes'? 'checked' : '' ?>>  YES &nbsp; &nbsp;
			<input class="form-check-input" type="radio" name="Enabled" id="Enabled" value= "No" <?php echo $userData['Enabled']=='No'? 'checked' : '' ?>>    NO  &nbsp; &nbsp;
		...
		<input class="form-check-input" type="radio" name="Status" id="Status" value= "Open" <?php echo $userData['Status']=='Open'? 'checked' : '' ?>>  Open &nbsp; &nbsp;
		<input class="form-check-input" type="radio" name="Status" id="Status" value= "Closed" <?php echo $userData['Status']=='Closed'? 'checked' : '' ?>>    Closed  &nbsp; &nbsp;
		</div>
		</div>	
